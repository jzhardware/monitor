    ...
    return function (a) {
        ...
        return b.e = function (a, c) {
            ...
            if (void 0 !== e[a]) e[a].push(c); else {
                ...
                f.type = "text/javascript", f.charset = "utf-8", f.async = !0, f.src = "../player/js/polyfills.promise.js", d.appendChild(f)
            }
        }, b.m = a, b.c = d, b.p = "", b(0)
    }([function (a, b, c) {
        a.exports = c(40)
        ...
        d = [c(46), c(62), c(47), c(48), c(61), c(60), c(45), c(63), c(165), c(166), c(167), c(59)], e = function (a, b, c, d, e, f, g, h, i, j, k, l) {
            var m = function (f, m) {
                ...
                return this.getPlugin = function (a) {
                    ...
                    var b = n.getItemQoe(), c = s.between("setup", "ready"),
                        d = b.between(a.JWPLAYER_MEDIA_PLAY_ATTEMPT, a.JWPLAYER_MEDIA_FIRST_FRAME);
                    return {setupTime: c, firstFrame: d, player: s.dump(), item: b.dump()}
                    ...
                    if (g.isBoolean(a) || (c = a), c || (c = {reason: "external"}), a === !0) return n.play(c), o;
        ...
        d = [], e = function () {
            var a = {}, b = Array.prototype, c = Object.prototype, d = Function.prototype, e = b.slice, f = b.concat,
                ...
                n = b.some, o = b.indexOf, p = Array.isArray, q = Object.keys, r = d.bind, s = function (a) {
        ...
        var d, e;
        d = [], e = function () {
            return "+commercial_v7-3-4.78.commercial.ba5b24.jwplayer.6040e1.analytics.5a0154.vast.0300bb.googima.e8ba93.plugin-sharing.08a279.plugin-related.909f55.plugin-gapro.0374cd"
        }.apply(b, d), !(void 0 !== e && (a.exports = e))
    }, function (a, b, c) {
        var d, e;
        d = [], e = function () {
        ...
        d = [c(64), c(81), c(158)], e = function (a, b, d) {
            ...
            return a.prototype.setup = function (a, f) {
                ...
                var g = this._model.get("edition"), h = b(g), i = this._model.get("cast"), j = this;
        ...
        d = [c(73), c(115), c(74), c(45), c(93), c(111), c(77), c(114), c(65), c(48), c(116), c(47), c(76), c(62), c(46), c(156)], e = function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            ...
            return s.prototype = {
                ...
                setup: function (g, l) {
                    ...
                    function q() {
                        X = null, D(U.get("item")), U.on("change:state", m, this), U.on("change:castState", function (a, b) {
                            ...
                            aa.trigger(o.JWPLAYER_FULLSCREEN, {fullscreen: b})
                        }), U.on("itemReady", function () {
                            aa.trigger(o.JWPLAYER_PLAYLIST_ITEM, {index: U.get("item"), item: U.get("playlistItem")})
                        }), U.on("change:playlist", function (a, b) {
                            b.length && aa.trigger(o.JWPLAYER_PLAYLIST_LOADED, {playlist: b})
                        }), U.on("change:volume", function (a, b) {
                            aa.trigger(o.JWPLAYER_MEDIA_VOLUME, {volume: b})
                        }), U.on("change:mute", function (a, b) {
                            aa.trigger(o.JWPLAYER_MEDIA_MUTE, {mute: b})
                        }), U.on("change:controls", function (a, b) {
                            aa.trigger(o.JWPLAYER_CONTROLS, {controls: b})
                        }), U.on("change:scrubbing", function (a, b) {
                            b ? y() : w()
                        }), U.on("change:captionsList", function (a, b) {
                            aa.trigger(o.JWPLAYER_CAPTIONS_LIST, {tracks: b, track: Q()})
                    ...
                    function s() {
                        for (aa.trigger(o.JWPLAYER_READY, {setupTime: 0}), aa.trigger(o.JWPLAYER_PLAYLIST_LOADED, {playlist: U.get("playlist")}), aa.trigger(o.JWPLAYER_PLAYLIST_ITEM, {
                            index: U.get("item"),
                            item: U.get("playlistItem")
                        }), aa.trigger(o.JWPLAYER_CAPTIONS_LIST, {
                            tracks: U.get("captionsList"),
                            track: U.get("captionsIndex")
                        }), U.get("autostart") && w({reason: "autostart"}); aa.eventsQueue.length > 0;) {
                            var a = aa.eventsQueue.shift(), b = a[0], c = a[1] || [];
                            aa[b].apply(aa, c)
                        }
                    }
                    ...
                    function w(a) {
                        ...
                        if (a && U.set("playReason", a.reason), U.get("state") !== n.ERROR) {
                            ...
                            if (U.get("state") === n.COMPLETE && (x(!0), D(0)), !$ && ($ = !0, aa.trigger(o.JWPLAYER_MEDIA_BEFOREPLAY, {playReason: U.get("playReason")}), $ = !1, Z)) return Z = !1, void (Y = null);
                            if (z()) {
                    ...
                    function C(a) {
                        var b = h(a);
                        return b = h.filterPlaylist(b, U.getProviders(), U.get("androidhls"), U.get("drm"), U.get("preload")), U.set("playlist", b), d.isArray(b) && 0 !== b.length ? !0 : (aa.triggerError({message: "Error loading playlist: No playable sources found"}), !1)
                    }
                    ...
                    function E(a) {
                        B(U.get("item") - 1, a || {reason: "external"})
                    }
                    ...
                    function G() {
                        if (z()) {
                            ...
                            Y = G;
                            var a = U.get("item");
                            return a === U.get("playlist").length - 1 ? void (U.get("repeat") ? F({reason: "repeat"}) : (U.set("state", n.COMPLETE), aa.trigger(o.JWPLAYER_PLAYLIST_COMPLETE, {}))) : void F({reason: "playlist"})
                        }
                    }
                    ...
                    function P(a) {
                        U.persistVideoSubtitleTrack(a), aa.trigger(o.JWPLAYER_CAPTIONS_CHANGED, {tracks: R(), track: a})
                    }
                    ...
                    var U, V, W, X, Y, Z, $ = !1, _ = !1, aa = this, ba = function () {
                        return U.getVideo()
                    }, ca = new a(g);
                    U = this._model.setup(ca), V = this._view = new k(l, U), W = new f(l, U), X = new e(l, U, V, C), X.on(o.JWPLAYER_READY, q, this), X.on(o.JWPLAYER_SETUP_ERROR, this.setupError, this), U.mediaController.on(o.JWPLAYER_MEDIA_COMPLETE, function () {
                        ...
                        var g = {img: a, tooltip: b, callback: c, id: e, btnClass: f}, h = U.get("dock");
                        h = h ? h.slice(0) : [], h = d.reject(h, d.matches({id: g.id})), h.push(g), U.set("dock", h)
                    }, this.removeButton = function (a) {
                        var b = U.get("dock") || [];
                        b = d.reject(b, d.matches({id: a})), U.set("dock", b)
                ...
                setupError: function (a) {
                    var b = a.message, c = j.createElement(p(this._model.get("id"), this._model.get("skin"), b)),
            ...
            var g = function () {
                function g(e) {
                    var g = c.tryCatch(function () {
                        ...
                        j.trigger(d.JWPLAYER_PLAYLIST_LOADED, {playlist: c})
                    });
                ...
                function i(a) {
                    j.trigger(d.JWPLAYER_ERROR, {message: a ? a : "Error loading file"})
                }
        ...
        d = [c(48), c(78), c(89), c(90), c(45), c(47), c(91), c(46), c(62)], e = function (a, b, c, d, e, f, g, h, i) {
            var j = ["volume", "mute", "captionLabel", "qualityLabel"], k = function () {
                ...
                this.mediaController = e.extend({}, f), this.mediaModel = new l, d.model(this), this.set("mediaModel", this.mediaModel), this.setup = function (b) {
                    ...
                    if (this.mediaModel.set("playAttempt", !0), this.mediaController.trigger(h.JWPLAYER_MEDIA_PLAY_ATTEMPT, {playReason: this.get("playReason")}), !a) {
                        var b = this.get("item");
        ...
        var d, e;
        d = [c(45)], e = function (a) {
            var b = "free", c = "premium", d = "enterprise", e = "ads", f = "unlimited", g = "trial", h = {
                setup: [b, c, d, e, f, g],
                dash: [c, d, e, f, g],
                drm: [d, e, f, g],
                hls: [c, e, d, f, g],
        ...
        d = [c(55), c(48), c(45), c(46), c(62), c(86), c(47)], e = function (a, b, c, d, e, f, g) {
            ...
            function m(m, y) {
                ...
                function F(a, b, c) {
                    (a !== Ha || c !== ya) && (Ha = a, Ca.trigger(d.JWPLAYER_MEDIA_BUFFER, {
                        bufferPercent: 100 * a, position: b, duration: c
                    }))
                }
                ...
                function Q() {
                    Ia && (b.log("Error playing media: %o %s", Ua.error, Ua.src || xa.file), Ca.trigger(d.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: File could not be played"}))
                }
                ...
                function S(a) {
                    Ba = a, Ja = T(a);
                    var b = R(a);
                    b && Ca.trigger(d.JWPLAYER_MEDIA_LEVELS, {levels: b, currentQuality: Ja})
                }

                function T(a) {
                    var b = Math.max(0, Ja), c = y.qualityLabel;
                    if (a) for (var d = 0; d < a.length; d++) if (a[d]["default"] && (b = d), c && a[d].label === c) return d;
                    return Sa.reason = "initial choice", Sa.level = {width: 0, height: 0}, b
                }
                ...
                function Z(a) {
                    if (a) {
                        ...
                        for (var b = 0; b < a.length; b++) if (-1 !== a[b].file.indexOf(".vtt") && /subtitles|captions|descriptions|chapters|metadata/.test(a[b].kind)) {
                ...
                function ba() {
                    Ca.trigger("volume", {volume: Math.round(100 * Ua.volume)}), Ca.trigger("mute", {mute: Ua.muted})
                }
                ...
                function da() {
                    var a = Ua.buffered, c = Ua.duration;
                ...
                function ha() {
                    var a = -1, b = 0;
                    if (Na) for (b; b < Na.length; b++) if ("showing" === Na[b].mode) {
                        a = b;
                        break
                    }
                    sa(a + 1)
                ...
                function ia() {
                    for (var a = -1, b = 0; b < Ua.audioTracks.length; b++) if (Ua.audioTracks[b].enabled) {
                        a = b;
                        break
                    }
                    oa(a)
                    ...
                    if (a && a.length && Ra !== a[0].startTime) {
                        var b = {
                            ...
                            if (!("value" in f) && "data" in f && f.data instanceof ArrayBuffer) {
                                var g = f, h = new Uint8Array(g.data);
                                f = {value: {key: "", data: ""}};
                        ...
                        Ra = a[0].startTime, Ca.trigger("meta", {metadataTime: Ra, metadata: f})
                    }
                }
                ...
                function ma(a) {
                    Ca.trigger("fullscreenchange", {target: a.target, jwstate: Ma})
                }
                ...
                function na(a) {
                    if (Oa = null, a) {
                        ...
                        j(a, "change", ia), Oa && Ca.trigger("audioTracks", {currentTrack: Qa, tracks: Oa})
                    }
                }
                ...
                function ra(a) {
                    if (Na = null, a) {
                        ...
                        j(a, "change", ha), Na && Na.length && Ca.trigger("subtitlesTracks", {tracks: Na})
                    }
                }
                ...
                function ua() {
                    if ("hls" === Ba[0].type) {
                        var a = "video";
                        0 === Ua.videoWidth && (a = "audio"), Ca.trigger("mediaType", {mediaType: a})
                    }
                }
                ...
                var wa, xa, ya, za, Aa, Ba, Ca = this, Da = {
                        click: A,
                        durationchange: B,
                        ended: ea,
                        error: Q,
                    ...
                    }, Ea = !1, Fa = 0, Ga = -1, Ha = -1, Ia = !0, Ja = -1, Ka = null, La = !1, Ma = !1, Na = null,
                    Oa = null, Pa = -1, Qa = -1, Ra = -1, Sa = {level: {}}, Ta = document.getElementById(m),
                ...
                Ua = Ua || document.createElement("video"), Ua.className = "jw-video jw-reset", h(Da, Ua), v || (Ua.controls = !0, Ua.controls = !1), Ua.setAttribute("x-webkit-airplay", "allow"), Ua.setAttribute("webkit-playsinline", ""), this.stop = function () {
                    ...
                    if (Ia) if (0 > a && (a += $() + _()), 0 === Fa && this.trigger(d.JWPLAYER_MEDIA_SEEK, {
                    ...
                    b = !!b, b || u ? a.style(wa, {visibility: "visible", opacity: 1}) : a.style(wa, {
                        visibility: "",
                        opacity: 0
                    })
                    ...
                    var e = {objectFit: ""};
                    if ("uniform" === d) {
                        var f = b / c, g = Ua.videoWidth / Ua.videoHeight;
                        Math.abs(f - g) < .09 && (e.objectFit = "fill", d = "exactfit")
                    }
                    var h = p || u || v || w;
                    if (h) {
                        var i = -Math.floor(Ua.videoWidth / 2 + 1), j = -Math.floor(Ua.videoHeight / 2 + 1),
                            k = Math.ceil(100 * b / Ua.videoWidth) / 100, l = Math.ceil(100 * c / Ua.videoHeight) / 100;
                    ...
                    if (Ja !== a && (a = parseInt(a, 10), a >= 0 && Ba && Ba.length > a)) {
                        ...
                        var b = Ua.currentTime || 0, c = Ua.duration || 0;
            ...
            var n = window.clearTimeout, o = 256, p = b.isIE(), q = b.isMSIE(), r = b.isMobile(), s = b.isSafari(),
                t = b.isFF(), u = b.isAndroidNative(), v = b.isIOS(7), w = b.isIOS(8), x = "html5", y = function () {
                };
        ...
        d = [c(48), c(45), c(46), c(62), c(88), c(86), c(47)], e = function (a, b, c, d, e, f, g) {
            ...
            function j(j, k) {
                ...
                var r, s, t, u = null, v = -1, w = !1, x = -1, y = null, z = -1, A = null, B = !0, C = !1, D = this,
                    E = function () {
                        return s && s.__ready
                    }, F = function () {
                    ...
                    init: function (a) {
                        ...
                        if (r !== e) {
                            r = e, s = this.getSwfObject(e), document.hasFocus() ? o() : window.addEventListener("focus", p), s.once("ready", function () {
                                ...
                                var a = b.extend({}, k), d = s.triggerFlash("setup", a);
                        ...
                        return t ? {name: "flash_" + t} : {name: "flash"}
        ...
        d = [c(95), c(81), c(80), c(45), c(48), c(57), c(97)], e = function (a, b, d, e, f, g, h) {
            ...
            function j(a, c) {
                var d = e.clone(c.get("plugins")) || {}, f = c.get("edition"), h = b(f), j = /^(vast|googima)$/,
                    k = /\.(js|swf)$/, l = g.repo(), m = c.get("advertising");
                if (h("ads") && m && (k.test(m.client) ? d[m.client] = m : j.test(m.client) && (d[l + m.client + ".js"] = m), delete m.client), h("jwpsrv")) {
                    var n = c.get("analytics");
//                    e.isObject(n) || (n = {}), i(d, n, "player/js/jwpsrv.js")
                    e.isObject(n) || (n = {}), i(d, n, "")
                }
                i(d, c.get("ga"), "gapro.js"), i(d, c.get("sharing"), "sharing.js"), i(d, c.get("related"), "related.js"), c.set("plugins", d), a()
            }

            function k(b, d) {
                var e = d.get("key") || window.jwplayer && window.jwplayer.key, i = new a(e), j = i.edition();
            ...
            function n() {
                var a = h.getQueue();
                return a.LOAD_DASH = {method: m, depends: ["CHECK_KEY", "FILTER_PLAYLIST"]}, a.CHECK_KEY = {
                    method: k,
        ...
        d = [c(98), c(65), c(101), c(58), c(45), c(48), c(46)], e = function (a, b, d, e, f, g, h) {
            ...
            function s(a, b) {
                return f.contains(e.SkinsLoadable, a) ? "../player/js/stormtrooper.css" : void 0
            }
            ...
            var e = function (e, f) {
                ...
                function h(a) {
                    ...
                    if (b && "textdata" === b.type) {
                        ...
                        var c = t[b.trackid];
                        if (!c) {
                            c = {kind: "captions", id: b.trackid, data: []}, l(c);
                            var d = o();
                        ...
                        var h = u[g];
                        h || (h = {begin: e, text: b.text}, b.end && (h.end = b.end), u[g] = h, c.data.push(h))
                    }
                }
                ...
                function n(e, f) {
                    ...
                    if (h) for ("xml" === a.localName(h) && (h = h.nextSibling); h.nodeType === h.COMMENT_NODE;) h = h.nextSibling;
                ...
                function o() {
                    for (var a = [{id: "off", label: "Off"}], b = 0; b < s.length; b++) a.push({
                        id: s[b].id,
        ...
        d = [c(117), c(46), c(154)], e = function (a, b, c) {
            var d = function (d, e) {
                ...
                return f.setup = function () {
                    ...
                    var b = a.get("castActive"), c = a.get("playlistItem"),
        ...
        d = [c(48), c(46), c(47), c(58), c(62), c(128), c(129), c(130), c(118), c(132), c(134), c(148), c(149), c(152), c(45), c(153)], e = function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            var q = a.style, r = a.bounds, s = a.isMobile(),
                ...
                u = function (u, v) {
                        ...
                        switch (Ga || aa(), a.keyCode) {
                            ...
                            default:
                                if (a.keyCode >= 48 && a.keyCode <= 59) {
                                    var b = a.keyCode - 48, c = b / 10 * v.get("duration");
                                    u.seek(c)
                                }
                        }
                    ...
                    function D() {
                        var a = r(ja), c = Math.round(a.width), d = Math.round(a.height);
                    ...
                    function J() {
                        v.get("state") !== e.IDLE && v.get("state") !== e.COMPLETE && v.get("state") !== e.PAUSED || !v.get("controls") || u.play({reason: "interaction"}), Ha ? _() : aa()
                    }

                    function K(a) {
                        a.link ? (u.pause(!0), u.setFullscreen(!1), window.open(a.link, a.linktarget)) : v.get("controls") && u.play({reason: "interaction"})
                    }
                    ...
                    function Q() {
                        ...
                        c.addEventListener("mousemove", aa), ra = new g(v, la, {useHover: !0}), ra.on("click", function () {
                            N({type: b.JWPLAYER_DISPLAY_CLICK}), v.get("controls") && u.play({reason: "interaction"})
                        }), ra.on("tap", function () {
                            N({type: b.JWPLAYER_DISPLAY_CLICK}), J()
                        }), ra.on("doubleClick", P), ra.on("move", aa), ra.on("over", aa);
                        var d = new h(v);
                        d.on("click", function () {
                            N({type: b.JWPLAYER_DISPLAY_CLICK}), u.play({reason: "interaction"})
                        }), d.on("tap", function () {
                            N({type: b.JWPLAYER_DISPLAY_CLICK}), J()
                        }), a.isChrome() && d.el.addEventListener("mousedown", function () {
                            var a = v.getVideo(), b = a && 0 === a.getName().name.indexOf("flash");
                            if (b) {
                                var c = function () {
                    ...
                    function T(b, c, d) {
                        ...
                        d = !!d, d && (f = f.replace(/\s*aspectMode/, ""), ja.className !== f && (ja.className = f), q(ja, {display: "block"}, d)), a.exists(b) && a.exists(c) && (v.set("width", b), v.set("height", c)), e = {width: b}, a.hasClass(ja, "jw-flag-aspect-mode") || (e.height = c), q(ja, e, !0), U(c), X(b, c)
                    }
                    ...
                    function Z(a) {
                        var b = v.get("fullscreen"), c = void 0 !== a.jwstate ? a.jwstate : Y();
                        b !== c && v.set("fullscreen", c), clearTimeout(Ia), Ia = setTimeout(X, 200)
                    }

                    function $(b, c) {
                        c ? (a.addClass(b, "jw-flag-fullscreen"), q(document.body, {"overflow-y": "hidden"}), aa()) : (a.removeClass(b, "jw-flag-fullscreen"), q(document.body, {"overflow-y": ""})), X()
                    }
                    ...
                    var ja, ka, la, ma, na, oa, pa, qa, ra, sa, ta, ua, va, wa, xa, ya, za, Aa, Ba, Ca, Da = -1,
                        Ea = s ? 4e3 : 2e3, Fa = 40, Ga = !1, Ha = !1, Ia = -1, Ja = -1, Ka = !1, La = !1,
                        Ma = o.extend(this, c);
                    this.model = v, this.api = u, ja = a.createElement(p({id: v.get("id")})), a.isIE() && a.addClass(ja, "jw-ie");
                    var Na = v.get("width"), Oa = v.get("height");
                    q(ja, {
                        ...
                        var c = v.get("id"), d = v.get("skinColorActive"), e = v.get("skinColorInactive"),
        ...
        "use strict";
        var d = c(122), e = c(124)["default"], f = c(125)["default"], g = c(123), h = c(126), i = function () {
        ...
        var f = c(123), g = c(125)["default"], h = "2.0.0";
        b.VERSION = h;
        var i = 6;
        ...
        var j = c(123), k = c(125)["default"], l = c(122).COMPILER_REVISION, m = c(122).REVISION_CHANGES,
            n = c(122).createFrame;
        ...
        d = [c(47), c(46), c(45), c(48)], e = function (a, b, c, d) {
            ...
            var i = !c.isUndefined(window.PointerEvent), j = !i && d.isMobile(), k = !i && !j,
                l = d.isFF() && d.isOSX(), m = function (a, d) {
                    function j(a) {
            ...
            var e = b.style, f = {
                ...
                q = document.createElement("div"), q.className = "jw-captions jw-reset", this.show = function () {
                    ...
                    if (r = document.createElement("div"), s = document.createElement("span"), r.className = "jw-captions-window jw-reset", s.className = "jw-captions-text jw-reset", t = d.extend({}, f, a), a) {
                        var c = t.fontOpacity, h = t.windowOpacity, i = t.edgeStyle, j = t.backgroundColor, k = {},
                            l = {
        ...
        d = [c(48), c(45), c(47), c(58), c(127), c(136), c(135), c(142), c(144), c(146), c(147)], e = function (a, b, c, d, e, f, g, h, i, j, k) {
            ...
            return b.extend(p.prototype, c, {
                setup: function () {
                    ...
                    var a, c, d, e, h = new g(this._model, this._api), p = new k("jw-icon-more");
        ...
        d = [c(45), c(48), c(58), c(136), c(139), c(140), c(141)], e = function (a, b, c, d, e, f, g) {
            var h = e.extend({
                ...
                constructor: function (b, c) {
                    ...
                    var e = this._model.get("duration"), f = b.adaptiveType(e);
                    if ("DVR" === f) {
                        var g = (1 - d / 100) * e, h = this._model.get("position"),
                            i = Math.min(g, Math.max(c.dvrSeekLimit, h)), j = 100 * i / e;
                        return 100 - j
                    }
                    return d
                }, update: function (a) {
                    ...
                    if (0 !== d) {
                        var e = b.bounds(this.elementRail), f = a.pageX ? a.pageX - e.left : a.x;
                        f = b.between(f, 0, e.width);
                        var g = f / e.width, h = d * g;
                        0 > d && (h = d - h);
                        var i;
                        if (this.activeCue) i = this.activeCue.text; else {
                            var j = !0;
            ...
            var e = {
                loadThumbnails: function (a) {
                    ...
                    var c = this.chooseThumbnail(b),
                        d = {display: "block", margin: "0 auto", backgroundPosition: "0 0"}, e = c.indexOf("#xywh");
                    if (e > 0) try {
        ...
        d = [c(45), c(48)], e = function (a, b) {
            ...
            return a.extend(e.prototype, {
                setup: function (a) {
                    ...
                    var d = "";
                    a.isString(c) && (d = 'url("' + c + '")'), b.style(this.el, {backgroundImage: d})
                }, element: function () {
                    return this.el
                }
            }), e
        ...
        d = [c(150), c(45), c(59)], e = function (a, b, c) {
            var d = {free: "f", premium: "r", enterprise: "e", ads: "a", unlimited: "u", trial: "t"}, e = function () {
            };
            return b.extend(e.prototype, a.prototype, {
                buildArray: function () {
                    var b = a.prototype.buildArray.apply(this, arguments), e = this.model.get("edition"), f = "#";
                    if (b.items[0].link = f, this.model.get("abouttext")) {
                        b.items[0].showLogo = !1, b.items.push(b.items.shift());
                        var g = {title: this.model.get("abouttext"), link: this.model.get("aboutlink") || f};
                        b.items.unshift(g)
                    }
                    return b
                }
        ...
        d = [c(48), c(151), c(45), c(127), c(59)], e = function (a, b, c, d, e) {
            ...
            return c.extend(f.prototype, {
                buildArray: function () {
                    var b = e.split("+"), c = b[0],
                        d = {items: [{title: "Click channels to reboot.", featured: !0, showLogo: !0, link: "#"}]},
                        f = c.indexOf("-") > 0, g = b[1];
                    if (f && g) {
                        var h = g.split(".");
        ...
        d = [], e = function () {
            ...
            function b() {
                ...
                var e = !1, f = a();
                return {onReady: b, checkAdBlock: d}
            }
...
jwplayer.key = "9Ecv7tcHwp5srVi6CKmKGPpMnYHRalrTWBJBhQ==";
jwplayer.defaults = {
    aspectratio: "16:9",
    autostart: true,
    controls: true,
    ...
    primary: "html5",
    repeat: true,
    skin: {"active": "#18ded0", "name": "stormtrooper"},
    stagevideo: false,
    stretching: "exactfit",
